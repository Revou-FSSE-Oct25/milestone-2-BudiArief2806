// clicker.ts
import { bindHomeButton, ensurePlayerExistsOrRedirect, CLICKER_BEST_KEY, CLICKER_DURATION, } from "../main.js";
const el = {
...
function startClicker() {
    ...
    if (el.clickerBtn) {
        const newBtn = el.clickerBtn.cloneNode(true);
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (el.startBtn)
        el.startBtn.addEventListener("click", startClicker);
});
